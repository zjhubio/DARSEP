"""
Original code from EvoPlay
Licensed under GPL-3.0
Copyright (c) 2023 Yi Wang
...
class Net(nn.Module):
    ...
    def __init__(self, board_width, board_height):
        ...
        self.act_conv1 = nn.Conv1d(128, 92, kernel_size=3, padding=1)
        self.act_fc1 = nn.Linear(4*board_width*board_height,
                                 board_width*board_height)
        # state value layers
        self.val_conv1 = nn.Conv1d(128, 23, kernel_size=3, padding=1)
